  ...
  return (
    <div className="min-h-screen p-8 pt-24">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Actividades al aire libre</h1>
        <img 
        ...
        <div className="prose max-w-none">
          <p className="text-lg mb-4">
            Nuestras actividades al aire libre están diseñadas para que los niños exploren y aprendan de la naturaleza de manera segura y divertida.
          </p>
